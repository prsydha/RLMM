...
DIRICHLET_ALPHA = 1.6       # More uniform noise (encourages trying new actions)
DIRICHLET_EPSILON = 0.5     # 50% noise, 50% policy - high exploration


# --- Exploration Settings ---
EPSILON_GREEDY = 0.50       # 20% chance of random action during training
...
# --- Warm Start Settings ---
WARM_START_COPIES = 10      # More expert demo copies to learn from
PRE_TRAIN_STEPS = 20       # More pre-training to establish good baseline
